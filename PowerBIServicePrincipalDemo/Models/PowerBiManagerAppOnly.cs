...
namespace PowerBIServicePrincipalDemo.Models {
  ...
  class PowerBiManagerAppOnly {
    ...
    public static void AddDatasourceToGateway() {
      ...
      var gateway = pbiClient.Gateways.GetGateways().Value.First();
      ...
      var credentialDetails = new CredentialDetails(
             new WindowsCredentials(@"DIONYSYS\TedP", "cu@4007Corona"),
      ...
      var request = new PublishDatasourceToGatewayRequest(
        dataSourceType: "SQL",
        connectionDetails: "{\"server\":\"dionysus\",\"database\":\"WingtipSalesDB\"}",
        credentialDetails: credentialDetails,
        dataSourceName: "Teds SQL Box");
